 ...
 */
package asteroids_shooting_game;
...
public class Asteroids_Shooting extends Applet implements Runnable, KeyListener {
...
String copyName = "Asteroids";
  ...
  static final int FIRE_DELAY = 10;         // Minimum number of milliseconds
                                            // required between photon shots.

  // Probablility of flying saucer firing a missle during any given frame
  // (other conditions must be met).

  static final double MISSLE_PROBABILITY = 1.00 / FPS;
